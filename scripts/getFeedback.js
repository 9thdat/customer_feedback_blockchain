        ...
        "outputs": [
            {
                ...
                "internalType": "struct Floopy.Feedback[]",
                "name": "",
                "type": "tuple[]"
            }
        ],
...
const floopyAddress = "0x468F4E312746Cd6C06DFDB7d2EAC6aF5Ff999Bff";
...
async function getFeedback(index) {
    ...
    try {
        let feedback = await floopyContract.methods.getFeedback(index).call();
